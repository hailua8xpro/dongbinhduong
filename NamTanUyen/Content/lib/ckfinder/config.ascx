...
<script runat="server">
	...
	public override bool CheckAuthentication()
	{
		...
		var ctrl = new NamTanUyen.Areas.cms.Controllers.BaseController();
        if (ctrl.IsLogged)
            return true;
        else
            return false;
	...
	public override void SetConfig()
	{
		...
		BaseUrl = "~/Content/lib/ckfinder/userfilesimages";

		// The phisical directory in the server where the file will end up. If
		// blank, CKFinder attempts to resolve BaseUrl.
		BaseDir = HttpContext.Current.Server.MapPath("~/Content/lib/ckfinder/userfilesimages");
